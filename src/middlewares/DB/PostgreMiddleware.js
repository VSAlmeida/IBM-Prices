...
module.exports = {
  //Método responsável por setar o preço dos flavors de PostgreSQL
  async setPrice(req, res, next) {
    api
      .get(
        '/databases-for-postgresql-standard:' + res.locals.location + '/pricing'
      )
      .then((result) => {
        ...
        let ramPrice = 0;
        let diskPrice = 0;
        //O preço do PostgreSQL é formado pela soma da vCpu, ram e disco
        ...
        //Onde estão todos os objetos com os flavors do PostgreSQL
        data.forEach((dataElement) => {
          if (dataElement.databaseEngine === 'PostgreSQL') {
